...
final class GenerateAnswerAction
{
    ...
    /**
     *
     * @param string $answerGenerationPromptName
     * @param string $topicExtractorPromptName
     ...
     * @param bool $lowDifficultyTasks
     * @return GenerateAnswerAction
     * @throws Exception
     */
